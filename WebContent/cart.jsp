...
<body>
	...
	<div class="navbar-inner">
		<a class="brand" href="home.jsp">MovieMadness</a> <a
					...
					<table id="product_table" class="table table-condensed">
						...
						<tbody>
							<c:forEach var="cart_products" items="${cart.items}">
								...
								<tr>
									<td class="cart_product"><a href=""><img alt="${products.name}"
											src="images/small/${products.id}.jpg" /></a></td>
									<td class="cart_description">
										<h4>
											<a href=""><c:out value="${products.name}" /></a>
										</h4> </br>
										<p class="info">
											Category :
										...
										<div class="form-horizontal">
											<form action="update" method="POST">
												<input type="hidden" name="productid"
													value="<c:out value="${products.id}"/>" /><input
...
-->
							...
							<tr>
								<td>&nbsp;</td>
								<td><a role="button" href="final_checkout.jsp"
									id="checkoutbutton" class="btn btn-primary">Proceed to
										Checkout
										</a></td>
								<td><a role="button" href="home.jsp"id="checkoutbutton" 
                                                                       class="btn btn-primary">Continue Shopping</a>									</a></td>
